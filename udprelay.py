...
# fastdnspy UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# fastdnspy UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# fastdnspy UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of fastdnspy
# `remote`  means remote server of fastdnspy
...
from fastdnspy import encrypt, obfs, eventloop, lru_cache, common, shell
from fastdnspy.common import pre_parse_header, parse_header, pack_addr
